...
// SOFT_POWER_STATE_FLASH_ADDR (one 4K sector): APP 软件开关机状态持久化
#define SOFT_POWER_STATE_FLASH_ADDR                   (USER_FLASH_START_ADDR + 0x5000)
 ...
 */
	...
	#define	UI_KEYBOARD_ENABLE						0
	#define UI_RADAR_ENABLE							1
	#define UI_STEP_MOTOR_ENABLE					1
#endif
